...
<html lang="en">
	<head>
		...
		<!---Line-icons css-->
<link href="assets/plugins/line-awesome/css/line-awesome.min.css" rel="stylesheet">
							...
							<div class="card custom-card">
								<div class="card-body">
									<div>
										...
										<p class="text-muted mb-2 card-sub-title"><span class="text-dark">See more flag icons <a href="icons-1.html" target="#flags">Flag Icons</a></span></p>

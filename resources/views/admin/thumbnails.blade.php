...
<figure class="highlight clip-widget" id="images2"><pre><code class="language-markup"><script type="html-dashlead/script"><div class="row">
	<div class="col-6 col-md-3">
		<img alt="Responsive image" class="img-thumbnail" src="https://laravel.spruko.com/dashlead/Leftmenu-Icon-Dark/assets/img/media/9.jpg">
	</div>
	<div class="col-6 col-md-3">
		<img alt="Responsive image" class="img-thumbnail" src="https://laravel.spruko.com/dashlead/Leftmenu-Icon-Dark/assets/img/media/13.jpg">
	</div>
	<div class="col-6 col-md-3 mg-t-10 mg-sm-t-0">
		<img alt="Responsive image" class="img-thumbnail" src="https://laravel.spruko.com/dashlead/Leftmenu-Icon-Dark/assets/img/media/14.jpg">
	</div>
	<div class="col-6 col-md-3 mg-t-10 mg-sm-t-0">
		<img alt="Responsive image" class="img-thumbnail" src="https://laravel.spruko.com/dashlead/Leftmenu-Icon-Dark/assets/img/media/15.jpg">
	</div>
</div></script></code></pre>
...
<figure class="highlight clip-widget" id="images3"><pre><code class="language-markup"><script type="html-dashlead/script"><div class="clearfix">
  <img src="https://laravel.spruko.com/dashlead/Leftmenu-Icon-Dark/assets/img/media/10.jpg" class="float-sm-left wd-100p wd-sm-200" alt="img">
  <img src="https://laravel.spruko.com/dashlead/Leftmenu-Icon-Dark/assets/img/media/11.jpg" class="float-sm-right wd-100p wd-sm-200 mg-t-10 mg-sm-t-0" alt="img">
</div></script></code></pre>
...
<figure class="highlight clip-widget" id="images5"><pre><code class="language-markup"><script type="html-dashlead/script"><div class="row">
	<div class="col-xs-12 col-md-6">
		<div class="img-thumbnail">
			<a href="#">
				<img src="https://laravel.spruko.com/dashlead/Leftmenu-Icon-Dark/assets/img/media/9.jpg" alt="thumb1" class="thumbimg">
			</a>
			<div class="caption">
				<h5>Thumbnail label</h5>
				<p>sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
	...
	<div class="col-xs-12 col-md-6">
		<div class="img-thumbnail">
			<a href="#">
				<img src="https://laravel.spruko.com/dashlead/Leftmenu-Icon-Dark/assets/img/media/8.jpg" alt="thumb1" class="thumbimg">
			</a>
			<div class="caption">
				<h5>Thumbnail label</h5>
				<p>sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
...
<!-- Prism Precode -->
<figure class="highlight clip-widget" id="images1"><pre><code class="language-markup"><script type="html-dashlead/script"><div><img alt="Responsive image" class="img-fluid" src="https://laravel.spruko.com/dashlead/Leftmenu-Icon-Dark/assets/img/media/7.jpg"></div>
</script></code></pre>
...
<figure class="highlight clip-widget" id="images4"><pre><code class="language-markup"><script type="html-dashlead/script"><figure class="pos-relative mg-b-0">
	<img alt="Responsive image" class="img-fit-cover" src="https://laravel.spruko.com/dashlead/Leftmenu-Icon-Dark/assets/img/media/12.jpg">
	<figcaption class="pos-absolute a-0 pd-25 bg-black-5 tx-white-8">
		<h6 class="tx-14 tx-sm-16 tx-white tx-semibold mg-b-15 mg-sm-b-20">What Does Royalty-Free Mean?</h6>
		<p class="mg-b-0">Royalty free means you just need to pay for rights to use the item once per end product. You does not need to pay additional or ongoing fees for each person who sees or uses it.</p>
	</figcaption>
